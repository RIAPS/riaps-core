...
struct Estimate {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(cb225cd542edaf7e, 1, 2)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand = &schema->defaultBrand;
    #endif  // !CAPNP_LITE
  };
...
inline  ::int16_t SensorValue::Reader::getValue() const {
  return _reader.getDataField< ::int16_t>(
      0 * ::capnp::ELEMENTS);
}

inline  ::int16_t SensorValue::Builder::getValue() {
  return _builder.getDataField< ::int16_t>(
      0 * ::capnp::ELEMENTS);
}
inline void SensorValue::Builder::setValue( ::int16_t value) {
