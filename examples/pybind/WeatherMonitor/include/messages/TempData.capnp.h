...
inline double TempData::Reader::getTemperature() const {
  return _reader.getDataField<double>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}

inline double TempData::Builder::getTemperature() {
  return _builder.getDataField<double>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}
inline void TempData::Builder::setTemperature(double value) {
