...
//        }
        ...
        GlobalEstimator::GlobalEstimator(const py::object *parent_actor, const py::dict type_spec, const std::string &name,
                                                 const std::string &type_name, const py::dict args,
                                                 const std::string &application_name, const std::string &actor_name)
                : GlobalEstimatorBase(parent_actor, type_spec, name, type_name, args, application_name,
                                      actor_name) {
